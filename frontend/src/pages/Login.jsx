...
export default function Login() {
  ...
  return (
    <div
      className="relative min-h-screen flex items-center justify-center overflow-hidden app-bg"
    >
      ...
      >
        ...
        <input
          ...
          required
          onChange={handleChange}
          className="w-full mb-6 p-3.5 rounded-xl bg-[#0b2342]/70 text-slate-100
          placeholder-sky-100/40 border border-sky-100/15 outline-none focus:border-emerald-200/50 focus:ring-1 focus:ring-emerald-200/50 transition-all shadow-inner"
        />
